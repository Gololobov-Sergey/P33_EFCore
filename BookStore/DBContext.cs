    ...
    public partial class DBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                {
                    new Book { Id = 1, Title = "Book 1", Pages = 100, PublishDate = DateOnly.FromDateTime(DateTime.Now) },
                    new Book { Id = 2, Title = "Book 2", Pages = 200, PublishDate = DateOnly.FromDateTime(DateTime.Now) },
                    new Book { Id = 3, Title = "Book 3", Pages = 300, PublishDate = DateOnly.FromDateTime(DateTime.Now) }
                });
